def import_and_create_accounts(filename):
    ...
    Every line in the file should be in the following format:
      username - password
    The key is a username and the value is a password. If the username and password fulfill the requirements,
    ...
    - Read in the file.
    - If the username and password fulfill the requirements, add the username and password
    into the user accounts dictionary, and update the login dictionary.
